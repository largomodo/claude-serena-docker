...
| `udev/`      | Host-side udev rules for USB hardware access (Tang Nano 4K VID:PID pairs)                              | Modifying USB device permissions, adding support for new Tang Nano board revisions         |
